...
MINISHELL_PRE_SRCS = 	main env_init env_utils exit parser_checks parser_utils \
						parser pipe prompt quotes_remove redirect_init redirect_parse \
						tokens tokens_convert utils \
